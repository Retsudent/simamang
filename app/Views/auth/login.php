        ...
        <div class="login-hero">
            ...
            <ul class="feature-list">
                <li>
                    ...
                    <span>Input log aktivitas harian dengan mudah</span>
                </li>
                <li>
                    <i class="bi bi-check-circle-fill"></i>
                    <span>Upload bukti aktivitas (PDF, gambar, dokumen)</span>
                </li>
                <li>
                    <i class="bi bi-check-circle-fill"></i>
                    <span>Komentar dan validasi dari pembimbing</span>
                </li>
                <li>
                    <i class="bi bi-check-circle-fill"></i>
                    <span>Generate laporan otomatis dalam format PDF</span>
                </li>
                <li>
                    <i class="bi bi-check-circle-fill"></i>
